...
if __name__ == "__main__":
    ...
    print(f"Dense Attention Matrix Size: {(seq_length * seq_length * 4) / 1024**2:.2f} MB per Head")
    ...
    print(f"The VRAM saved here is what gives us the headroom to dynamically stream .mrna adapters!")
